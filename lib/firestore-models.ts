...
export function normalizeTable(id: string, data: Record<string, unknown>): Table {
  ...
  return {
    ...
    sessionStartedAt: toMillis(data.sessionStartedAt),
    sessionExpiresAt: toMillis(data.sessionExpiresAt),
...
export function normalizeWaiterCall(id: string, data: Record<string, unknown>): WaiterCall {
  ...
  return {
    ...
    paymentStatus: data.paymentStatus === 'paid' ? 'paid' : data.paymentStatus === 'unpaid' ? 'unpaid' : undefined,
    paidAt: toMillis(data.paidAt) ?? undefined,
    paidById: typeof data.paidById === 'string' ? data.paidById : undefined,
    paidByName: typeof data.paidByName === 'string' ? data.paidByName : undefined,
    paidByRole: data.paidByRole === 'admin' || data.paidByRole === 'waiter' ? data.paidByRole : undefined,
